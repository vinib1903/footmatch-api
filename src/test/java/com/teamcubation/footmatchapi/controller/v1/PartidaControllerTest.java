...
import com.teamcubation.footmatchapi.adapters.inbound.controller.v1.PartidaController;
...
public class PartidaControllerTest {
    ...
    @Test
    void testCreateMatchWhenDataIsValid_shouldReturnIsGone() throws Exception {
    ...
    @Test
    void testSearchMatches_shouldReturnPageOfMatches() throws Exception {
    ...
    @Test
    void testGetMatchById_shouldReturnIsOk() throws Exception {
    ...
    @Test
    void testUpdateMatch_shouldReturnIsGone() throws Exception {
    ...
    @Test
    void testDeleteMatch_shouldReturnIsGone() throws Exception {
